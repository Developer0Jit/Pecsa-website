    ...
    <main className="home-container d-flex flex-column">
      ...
      <section className="company-profile row mt-5 px-3 px-md-5 text-center text-md-start">
        <div className="col-12">
          <Link to="/" className="navbar-brand fs-2 text-accent">
            PECSA IT Solutions
          </Link>
        </div>
      ...
      <section className="row my-5 py-4 year-section align-items-center justify-content-center">
        <div className="col-11 col-md-10 rounded-pill text-white d-flex  flex-md-row align-items-center justify-content-center py-5 year-content">
          ...
          <div className="year-numbers px-5 d-flex flex-column align-items-center justify-content-center">
            <h2>2</h2>
            <h2>0</h2>
            <h2>2</h2>
            <h2>5</h2>
